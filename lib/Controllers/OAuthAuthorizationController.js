...
class OAuthAuthorizationController {
     ...
     * @returns {Promise}
     */
    static createRequestToken(authorization, code, redirectUri, fieldParameters, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/qaqa'}`;
     ...
     * @returns {Promise}
     */
    static createRefreshToken(authorization, refreshToken, scope, fieldParameters, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
