...
class OAuthManager {
    ...
    static buildAuthorizationUrl(scope, state) {
        ...
        let _queryBuilder = `${_baseUri}${'/qaqa'}`;
    ...
    static authorize(code, params, cb) {
        ...
        const promise = _oAuthController.createRequestToken(authHeader, code, redirectUri, params, cb);
    ...
    static refreshToken(scope, fieldParams, callback) {
        ...
        const refreshPromise =
          _oAuthController.createRefreshToken(authHeader, token, scopeString, fieldParams, callback);
